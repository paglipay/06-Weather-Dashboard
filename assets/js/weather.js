...
$(document).ready(function () {
    ...
    var listEl = document.querySelector("#cities-list");
...
var renderWeather = name => {
    url_var = 'https://api.openweathermap.org/data/2.5/weather?q=' + name + '&appid=aff4268b5009fde02d6331d776dde947'
    $.ajax({
        url: url_var,
        method: "GET"
